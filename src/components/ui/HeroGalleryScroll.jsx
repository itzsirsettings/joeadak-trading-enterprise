  ...
  return (
    <ContainerScroll className="h-[350vh]">
      ...
      <ContainerScale className="relative z-10 text-center">
        <h1 className="max-w-xl text-5xl font-bold tracking-tighter text-deepBlue drop-shadow-lg">
          JOEADAK Trading Enterprise
        </h1>
        <p className="my-6 max-w-xl text-lg text-gold font-medium drop-shadow-md">
          Professional freelance and consulting solutions for businesses, organizations, and communities.
        </p>
        <div className="flex items-center justify-center gap-4">
          <a
            href="/contact"
            className="bg-gold text-deepBlue px-8 py-4 font-bold rounded-lg hover:bg-yellow-500 hover:shadow-gold-lg transition-all transform hover:-translate-y-1"
          >
            Get Started
          </a>
          <a
            href="/about"
            className="bg-white/20 backdrop-blur-sm text-white border-2 border-white font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-deepBlue transition-all"
          >
            Learn more
          </a>
        </div>
...
export { ContainerScroll, BentoGrid, BentoCell, ContainerScale, HeroGalleryScroll }
