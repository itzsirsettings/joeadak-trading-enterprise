...
function computeClickActionBase(event, nodePrivacyLevel, configuration) {
    ...
    const selector = (0, getSelectorFromElement_1.getSelectorFromElement)(target, configuration.actionNameAttribute);
    if (selector) {
        (0, interactionSelectorCache_1.updateInteractionSelector)(event.timeStamp, selector);
    }
    const { name, nameSource } = (0, getActionNameFromElement_1.getActionNameFromElement)(target, configuration, nodePrivacyLevel);
    return {
